	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    ...
	    <ul class="navbar-nav navbar-right" id="loginUL">
		    ...
		    <%	} else { %>
		    	<li>
		    		<button id="loggedInAccountBtn" type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		    		...
		    		<div id="profileDropdown" class="dropdown-menu dropdown-menu-right">
		    			...
		    			<a id="myProfileBtn" class="dropdown-item" href="<%= request.getContextPath() %>/profile?id=<%= session.getAttribute("accountPKey").toString() %>">My Profile</a>
