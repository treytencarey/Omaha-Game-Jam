...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/Styles/newsStyle.css">
</head>
<style>
.zoom {
...
<body>
	...
	<div class="dropdown text-center" style="align: center;">
		<button style="background-color: #0377FC; border-color: #0377FC;"
		...
		<div class="dropdown-menu" aria-labelledby="yearDropdown">
			...
			<a class="dropdown-item"
				href="<%=request.getContextPath()%>/News/Archive?year=<%=i%>"><%=i%></a>
			<%
				}
			%>
		</div>
	...
	<ul class="list-unstyled">
		...
		%>
		<a
			href="<%=request.getContextPath()%>/News/view?id=<%=newsPosts[i].getKey()%>">
			<li class="media archive-item"><img
				class="mr-3 archive-img-container"
				src="<%=request.getContextPath() + "/Uploads/News/Photo/" + newsPosts[i].getKey() + "_header.png"%>">
