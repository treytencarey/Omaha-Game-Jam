...
<body>
	...
	<div class="dropdown text-center" style="align: center;">
		<button style="background-color: #0377FC; border-color: #0377FC;" class="btn btn-secondary dropdown-toggle" type="button" id="yearDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Select Year</button>
